...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT,NAME TEXT,BANK TEXT,PHONENUMBER INTEGER)");
    }
    ...
    public boolean insertData(String name, String bank, String phonenumber) {
    ...
    public boolean updateData(String id, String name, String bank, String phonenumber) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
